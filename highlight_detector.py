...
import decoder
from settings import (DEFAULT_FS, DEFAULT_OVERLAP_RATIO,
...
class HighlightDetector:
    ...
    def fingerprint_directory(self, path: str, extensions: str, nprocesses: int = None) -> None:
        ...
        # Send off our tasks
        iterator = pool.imap_unordered(HighlightDetector._fingerprint_worker, worker_input)
        songs = []
        fingerprints = []
    ...
    def fingerprint_file(self, file_path: str, song_name: str = None) -> None:
        ...
        if song_hash in self.songhashes_set:
            ...
            song_name, hashes, file_hash = HighlightDetector._fingerprint_worker(
    ...
    def _fingerprint_worker(arguments, song_name=None):
        ...
        fingerprints, file_hash = HighlightDetector.get_file_fingerprints(file_name, limit, print_output=True)
